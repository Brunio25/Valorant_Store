package com.valorant.store.main.components
...
import com.valorant.store.main.util.ColorUtil
import java.util.UUID

val mockSkin = SkinEntity(
...
val mockCurrency = CurrencyEntity(
    "VALORANT POINTS",
    "VALORANT POINT",
...
val mockContentTier = ContentTierEntity(
...
fun SkinDisplayComponent(
    skin: SkinEntity = mockSkin,
    prices: Map<CurrencyEntity, Int> = mapOf(mockCurrency to 1500),
    contentTier: ContentTierEntity = mockContentTier
) {
